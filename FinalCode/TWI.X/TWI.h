 ...
 */
typedef void (*I2C_ReceiveCallback)(uint8_t);
 ...
 */
void TWI_Master_Start(uint8_t, uint8_t);
 ...
 */
void TWI_Slave_Init(uint8_t, I2C_ReceiveCallback, I2C_TransmitCallback);
